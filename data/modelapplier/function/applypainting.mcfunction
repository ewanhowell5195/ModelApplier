...
data modify entity @n[type=armor_stand,name=ModelApplier] equipment.mainhand.components.minecraft:painting/variant set from entity @n[type=armor_stand,name=ModelApplier] equipment.mainhand.components.minecraft:custom_name
